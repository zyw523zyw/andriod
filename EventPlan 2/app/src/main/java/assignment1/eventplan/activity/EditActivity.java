...
public class EditActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etAtten.setOnClickListener(new View.OnClickListener() {
            public void onClick(View view) {
                Intent intent = new Intent(EditActivity.this, ContactsPickerActivity.class);
    ...
    private void initData(EventEntity eventEntity) {
        if (eventEntity != null) {
            ...
            startEdit.setText(eventEntity.getStartDate());
            startTimeEdit.setText(eventEntity.getStartTime());
            endTimeEdit.setText(eventEntity.getEndTime());
            endEdit.setText(eventEntity.getEndDate());
            venueEdit.setText(eventEntity.getVeune());
            etLat.setText(eventEntity.getLocationX());
            etLog.setText(eventEntity.getLocationY());
    ...
    private void updateEvent() {
        ...
        if (eventEntity != null) {
            ...
            DbUtil.updateEvent(eventEntity);
    ...
    class MyDateTouchListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                View view = View.inflate(EditActivity.this, R.layout.activity_datepicker, null);
    ...
    class MyTimeTouchListener implements View.OnTouchListener {
        ...
        public boolean onTouch(View v, MotionEvent event) {
            ...
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                AlertDialog.Builder builder = new AlertDialog.Builder(EditActivity.this);
                View view = View.inflate(EditActivity.this, R.layout.activity_timepicker, null);
